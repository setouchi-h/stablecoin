 ...
 *
 * It is similar to DAI if DAI had bo governance, no fee, and was only backed by WETH and WBTC.
 *
...
contract DSCEngine is ReentrancyGuard {
    ...
    function mintDsc(uint256 amountDscToMint) public moreThanZero(amountDscToMint) nonReentrant {
        ...
        // if they minted to much, revert ($150 DSC, $100 collateral)
        _revertIfHealthFactorIsBroken(msg.sender);
    ...
    // $75 ETH backing $50 DSC (threshold)
    // Liquidator take $75 backing and burns off $50 DSC
    /**
     * @param collateral The ERC20 token address of the collateral you're using to make the protocol solvent again.
     * This is collateral that you're going to take from the user who is insolvent.
     * In return, you have to burn your DSC to pay off their debt, but you don't pay off your own.
     * @param user The user who has broken the health factor. They have to have a _healthFactor below MIN_HEALTH_FACTOR
     ...
     *
     * @notice Follws CEI: Checks, Effects, Interactions
     */
    ...
    function _healthFactor(address user) private view returns (uint256) {
        ...
        // return (collateralValueInUsd / totalDscMinted); 小数は扱えない！！
    }
